...
export default function Rectangle() {
  return (
    <section
      className="mt-10 font-poppins  font-bold text-[16px] flex flex-col py-10 md:py-0 md:flex-row md:gap-4 relative h-[380px] w-[361px] md:w-[1090px]  md:h-[159px] bg-[#E2E5EA]"
      style={{ opacity: 0.7 }}
    >
